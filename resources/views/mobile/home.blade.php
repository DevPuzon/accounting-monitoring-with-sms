    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" id="main-container">
            <div class=" ">
                ...
                <a href="{{ url('mobile/change_password')}}" style="text-decoration: underline;color:#266DD9;">Change Password</a>
            </div>
        </div>
    </div>
</div>
