    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" id="main-container">
            <div  style=" margin-top: 200px;width:100%; ">  
                @foreach ($logs as $log) 
                    <div class="card notification-list" style="margin-bottom:10px" >
                        <div class="card-body">  
                            ...
                            <p class="log-item" style="overflow: hidden; 
                            display: -webkit-box;
                            -webkit-line-clamp: 3;
...
<button id="trigger-modal" style=" display: none; " type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
</button>
...
<div class="modal-dialog" role="document">
    ...
    <div id="notif-modal-body" class="modal-body">
         
    </div>
    <div class="modal-footer">
        <button onclick="window.location.href = '{{ url('mobile/chat') }}'" type="button" class="btn btn-sm btn-primary" data-dismiss="modal">Message Admin</button>
...
<script>
    ...
    $(".notification-list").click(function() {
        var index = $('.notification-list').index(this);
        var text = document.getElementsByClassName("log-item")[index].innerText; 
        $("#trigger-modal").click();
        $("#notif-modal-body").html(text);
    }); 
    function openNotification(log){
    }
</script>
